...
use super::{super::ScaleChangeArgs, media_query_handle::MediaQueryListHandle};
...
impl ScaleChangeDetectorInternal {
	...
	fn create_mql(closure:Closure<dyn FnMut(MediaQueryListEvent)>) -> Option<MediaQueryListHandle> {
		let current_scale = super::scale_factor();
