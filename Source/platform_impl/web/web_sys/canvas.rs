...
use super::{event, event_handle::EventListenerHandle, media_query_handle::MediaQueryListHandle};
use crate::{
	dpi::{LogicalPosition, PhysicalPosition, PhysicalSize},
	error::OsError as RootOE,
...
struct Common {
	/// Note: resizing the HTMLCanvasElement should go through
...
impl Canvas {
	...
	pub fn raw(&self) -> &HtmlCanvasElement { &self.common.raw }
	...
	pub fn request_fullscreen(&self) { self.common.request_fullscreen() }

	pub fn is_fullscreen(&self) -> bool { self.common.is_fullscreen() }
